...
ExtUx.Ajax = function () {
     ...
     */
    const requestExceptionHandler = function (conn, response, options) {
     ...
     */
    const beforeRequestHandler = function (conn, options) {
     ...
     *  取消mask
     */
    const requestCompleteHandler = function (conn, response, options) {
    ...
    return {
        ...
        //successOperate
        sucOpr: function (response, option) {
            var succFn = option.succFn,
                failFn = option.failFn,
                isSuccTip = option.isSuccTip,
                isFailTip = option.isFailTip,
                responseText = response.responseText,
                result = {};
